    ...
    def nearest_bee(self):
        ...
        while True:
            if target_place.is_hive:
                return None
            elif target_place.bees and self.lower_bound <= distance <= self.upper_bound:
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        while not place.is_hive:
            ...
            if place.ant and place.ant is not self:
                ...
                if distance > 0 and place.ant.is_container and place.ant.contained_ant:
                    ret[place.ant.contained_ant] = distance
            distance += 1
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 2
        ret = 2 - 0.0625 * self.insects_shot - 0.25 * distance
        return max(ret, 0)
        # END Problem Optional 2
